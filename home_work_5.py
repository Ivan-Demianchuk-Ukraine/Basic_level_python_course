...
#
# k_index = 5
# print('Should be deleted number with index - ', k_index)
# item_with_k_index = my_list[5]
# print('item under k index - ', item_with_k_index)
# my_list.remove(item_with_k_index)
# print(my_list)
...
#   в списке увеличивается, в конец списка нужно будет добавить новый элемент (любое значение), используя метод append().
...
# k_index = random.randint(3, 7)
# print('k_index is - ', k_index)
# C = 'C'
#
# for i in my_list:
#     if my_list.index(i) == k_index:
#         print('before', my_list)
#         print('qwe', my_list[:k_index])
#         my_list = my_list[:k_index] + list(C) + my_list[k_index:]
...
# a, b = [1, 2, 3, 4, 5, 5, 5, 0], [0, 2, 4, 6, 7, 5, 4, 1]
# print(len([print('Yes', x) for x in a if a.count(x) == 1]), len([print('Yes', y) for y in b if b.count(y) == 1]))
