...
if len_list_1 % 2 == 0 and len_list_2 % 2 != 0:
    for i in range(1, len_list_1, 2):
        my_result.append(my_list_1[i])
    for i in range(0, len_list_2, 2):
        my_result.append(my_list_2[i])
elif len_list_1 % 2 != 0 and len_list_2 % 2 == 0:
    for i in range(1, len_list_1, 2):
        my_result.append(my_list_1[i])
    for i in range(0, len_list_2, 2):
        my_result.append(my_list_2[i])
